<?php
    ...
    // 取得したデータを、表示に使用（ここはHTMLタグの方に記述）


    //更新ボタンが押されたとき、編集したつぶやきをUPDATEする
    if (isset($_POST['tweet'])){
      //UPDATE文作成
      $sql = 'UPDATE `tweets` SET `tweet`=? WHERE `tweet_id`=?'; //<- 要作成

      $data = array($_POST['tweet'],$_GET['tweet_id']); //<- 要作成
